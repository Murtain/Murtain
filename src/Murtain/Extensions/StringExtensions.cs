...
namespace Murtain.Extensions
{
    ...
    public static class StringExtensions
    {
        ...
        public static string TryCamelCase(this string str)
        {
            return str.TryCamelCase(CultureInfo.InvariantCulture);
        }
        ...
        /// <returns>camelCase of the string</returns>
        public static string TryCamelCase(this string str, CultureInfo culture)
        {
        ...
        public static T TryEnum<T>(this string value)
            where T : struct
        {
            if (value == null)
            {
        ...
        /// <returns>Returns enum object</returns>
        public static T TryEnum<T>(this string value, bool ignoreCase)
            where T : struct
        {
            if (value == null)
            {
        ...
        public static string TryPascalCase(this string str)
        {
            return str.TryPascalCase(CultureInfo.InvariantCulture);
        }
        ...
        /// <param name="culture">An object that supplies culture-specific casing rules</param>
        /// <returns>PascalCase of the string</returns>
        public static string TryPascalCase(this string str, CultureInfo culture)
        {
            if (string.IsNullOrWhiteSpace(str))
            {
                return str;
